...
public class CommonUtil {
     ...
     * @param b
     */
   public  static void updateApk(Activity context, String path, String clientVer, String updateContent, boolean b) {

//        UpdateAppUtils.from(context)
//                .serverVersionCode(100)
//                .serverVersionName(clientVer)
//                .apkPath(path)
//                .showNotification(true) //是否显示下载进度到通知栏
