package com.ltz.o2o.widget.flowtag;
...
//            addView(childView,
//              new MarginLayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));//这个构造方法虽然能使用但是编译器会报错
...
//                            }
     ...
     * @param datas
     */
    public void setTagItemClickablefalse(List<Integer> datas){
        ToastUtil.ShortToast("设置不可点击");
       // reloadData(datas);
    }
